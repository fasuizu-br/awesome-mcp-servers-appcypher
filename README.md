...
- 🔊 [Brainiall TTS](https://github.com/fasuizu-br/brainiall-tts-mcp) - Hosted text-to-speech with 54 voices across nine languages and WAV output (requires a Brainiall API key).
