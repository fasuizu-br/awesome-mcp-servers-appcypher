...
- <img src="https://www.svgrepo.com/show/532779/microphone.svg" height="14"/> [Speech AI](https://github.com/fasuizu-br/speech-ai-examples) - Production speech AI with pronunciation scoring, speech-to-text, and text-to-speech via MCP. 10 tools including phoneme-level assessment, audio transcription, multi-voice synthesis, and phoneme inventory lookup.
